...
export class HelpCenterMockApi {
  ...
  registerHandlers(): void {
    ...
    // @ FAQs - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/help-center/faqs').
        reply(({request}) => {
    ...
    // @ Guides - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/help-center/guides').
        reply(({request}) => {
              ...
              results.push(
                  {
                    ...
                    totalGuides: guides.filter(
                        guide => guide.categoryId === category.id).length,
    ...
    // @ Guide - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/help-center/guide').
        reply(({request}) => {
