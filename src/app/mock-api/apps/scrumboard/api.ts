...
export class ScrumboardMockApi {
  ...
  registerHandlers(): void {
    ...
    // @ Boards - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/scrumboard/boards').
        reply(({request}) => {
          ...
          boards = boards.map(board => ({
            ...board,
            members: board.members.map(boardMember => this._members.find(
    ...
    // @ Board - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/scrumboard/board').
        reply(({request}) => {
          ...
          board.lists = this._lists.filter(item => item.boardId === id).
          ...
          cards = cards.map(card => (
              {
                ...card,
                labels: card.labels.map(cardLabelId => this._labels.find(
          ...
          board.lists.forEach((list, index, array) => {
            array[index].cards = cards.filter(
    ...
    // @ List - POST
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPost('api/apps/scrumboard/board/list').
        reply(({request}) => {
    ...
    // @ List - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/scrumboard/board/list').
        reply(({request}) => {
    ...
    // @ Lists - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/scrumboard/board/lists').
        reply(({request}) => {
    ...
    // @ List - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onDelete('api/apps/scrumboard/board/list').
        reply(({request}) => {
    ...
    // @ Card - PUT
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPut('api/apps/scrumboard/board/card').
        reply(({request}) => {
    ...
    // @ Card - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/scrumboard/board/card').
        reply(({request}) => {
    ...
    // @ Cards - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/scrumboard/board/cards').
        reply(({request}) => {
          ...
          cards.forEach((item) => {
            ...
            // Attach the labels of the card
            item.labels = item.labels.map(cardLabelId => this._labels.find(
                label => label.id === cardLabelId));
    ...
    // @ Card - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onDelete('api/apps/scrumboard/board/card').
        reply(({request}) => {
    ...
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch(
        'api/apps/scrumboard/board/card/positions').reply(({request}) => {
      ...
      this._cards.forEach((card) => {
        ...
        card.position = cards.findIndex(
            item => item.id === card.id && item.listId === card.listId &&
    ...
    // @ Labels - GET
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onGet('api/apps/scrumboard/board/labels').
        reply(({request}) => {
    ...
    // @ Label - PUT
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPut('api/apps/scrumboard/board/label').
        reply(({request}) => {
    ...
    // @ Label - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onPatch('api/apps/scrumboard/board/label').
        reply(({request}) => {
    ...
    // @ Label - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._fuseMockApiService.onDelete('api/apps/scrumboard/board/label').
        reply(({request}) => {
