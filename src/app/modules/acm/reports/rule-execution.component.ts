...
@Component({
    ...
    <p-panel header="Transaction executed by User at Rule Level">
...
export class RuleExecutionComponent implements AfterViewInit, OnInit {
    countries = [
    ...
    mainCols = [
        ...
        { field: 'description', type: 'text', header: 'Rule' },
        { field: 'business-process', type: 'text', header: 'Description' },
        { field: 'sub-process', type: 'text', header: 'User Id' },
        { field: 'sub-process', type: 'text', header: 'Name' },
        { field: 'sub-process', type: 'text', header: 'Transaction' },
        { field: 'sub-process', type: 'text', header: 'Description' },
        { field: 'sub-process', type: 'text', header: 'Date' },
    ];
    subCols = [
