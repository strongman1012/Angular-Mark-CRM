...
@Component({
    ...
    <p-panel header="Risks Executed by User">
...
export class RiskExecutionComponent implements AfterViewInit, OnInit {
    countries = [
    ...
    mainCols = [
        ...
        { field: 'description', type: 'text', header: 'Risk' },
        { field: 'business-process', type: 'text', header: 'Description' },
        { field: 'sub-process', type: 'text', header: 'Rule' },
