...
export class OrgLevelAnalysis implements AfterViewInit, OnInit {
    tableOneTitle = "Org Level Analysis"
    ...
    mainCols = [
        ...
        { field: 'rule', type: 'text', header: 'Target' },
        { field: 'rule', type: 'text', header: 'Analysis' },
