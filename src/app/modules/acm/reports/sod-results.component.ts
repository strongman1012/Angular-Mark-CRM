...
export class SodResultsComponent implements AfterViewInit, OnInit {
    ...
    table1 = [
        ...
        { field: 'description', type: 'text', header: 'Profile' },
        { field: 'business-process', type: 'text', header: 'Status' },
        { field: 'sub-process', type: 'text', header: 'Started On' },
        { field: 'sub-process', type: 'text', header: 'Target' },
        { field: 'sub-process', type: 'text', header: 'Analysis' },
        { field: 'sub-process', type: 'text', header: 'Mitigation' },
        { field: 'sub-process', type: 'text', header: 'Org Fields' },
        { field: 'sub-process', type: 'text', header: 'Run By' },
    ];
    table2 = [
        { field: 'rule', type: 'text', header: 'System' },
        { field: 'description', type: 'text', header: 'Profile' },
    ...
    table4 = [
        { field: 'rule', type: 'text', header: 'Profile' },
        { field: 'description', type: 'text', header: 'Status' },
        { field: 'sub-process', type: 'text', header: 'Started On' },
        { field: 'sub-process', type: 'text', header: 'Target' },
        { field: 'sub-process', type: 'text', header: 'Analysis' },
        { field: 'sub-process', type: 'text', header: 'Mitigation' },
    ...
    table5 = [
        ...
        { field: 'sub-process', type: 'text', header: 'Profile Type' },
        { field: 'sub-process', type: 'text', header: 'Run By' },
    ];
