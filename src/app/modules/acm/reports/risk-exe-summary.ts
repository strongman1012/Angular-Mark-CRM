...
export class RiskExeSummary implements AfterViewInit, OnInit {
    tableOneTitle = "Risk Execution Summary"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'System' },
        { field: 'rule', type: 'text', header: 'User ID' },
        { field: 'rule', type: 'text', header: 'User Name' },
        { field: 'rule', type: 'text', header: 'Risks Executed' },
    ];
