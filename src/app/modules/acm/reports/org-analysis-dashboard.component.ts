    ...
    <div class="w-full">
        <div class="flex flex-row px-10">
            ...
            <div class="w-60 ml-auto">
                <p-dropdown class="" autoWidth="false" [options]="groupedItems" [style]="{'width':'100%'}" [group]="true"></p-dropdown>
            </div>
        </div>
        <div class="bg-white px-10">
            BOBJ <br>
            No results available currently for SAP System: BOBJ
        </div>
    </div> 
    `,
    encapsulation: ViewEncapsulation.None,
})
export class OrgAnalysisDashboard implements AfterViewInit, OnInit {
    groupedItems = [

    ];
    tableOneTitle = "Cross System Analysis";
    rowsPerPageOptions = [3, 4, 5];
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Profile' },
        { field: 'rule', type: 'text', header: 'Status' },
        { field: 'rule', type: 'text', header: 'Started On' },
        { field: 'rule', type: 'text', header: 'Completed On' },
        { field: 'rule', type: 'text', header: 'Primary' },
        { field: 'rule', type: 'text', header: 'Secondery' },
        { field: 'rule', type: 'text', header: 'Run By' },
    ];
