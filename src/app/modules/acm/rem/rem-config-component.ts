...
@Component({
    ...
    <div class="w-full">
        <mat-tab-group>
            ...
            <mat-tab label="Duration Configuration">
                <app-table 
                    [title]=tableOneTitle 
                    [cols]=table3 
                    [data]=data 
...
export class RemConfigComponent implements AfterViewInit, OnInit {
    tableOneTitle = " "
    tableTwoTitle = "Rules"
    ...
    table1 = [
        ...
        { field: 'business-process', type: 'text', header: 'SID' },
        { field: 'sub-process', type: 'text', header: 'Active' },
    ];
    table2 = [
        { field: 'rule', type: 'text', header: 'Rule' },
        { field: 'description', type: 'text', header: 'System' },
        { field: 'business-process', type: 'text', header: 'SID' },
        { field: 'sub-process', type: 'text', header: 'Active' },
    ];
    table3 = [
        { field: 'rule', type: 'text', header: 'Start From' },
        { field: 'description', type: 'text', header: 'System' },
        { field: 'business-process', type: 'text', header: 'SID' },
        { field: 'sub-process', type: 'text', header: 'Active' },
    ];
