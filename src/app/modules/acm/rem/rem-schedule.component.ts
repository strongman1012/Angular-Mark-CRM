...
export class RemScheduleComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Scheduled REM Tasks"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Profile' },
        { field: 'rule', type: 'text', header: 'Start Date' },
        { field: 'rule', type: 'text', header: 'End Date' },
        { field: 'rule', type: 'text', header: 'Next Execution' },
        { field: 'rule', type: 'text', header: 'Last Execution' },
        { field: 'rule', type: 'text', header: 'Status' },
        { field: 'rule', type: 'text', header: 'Enabled' },
    ];
