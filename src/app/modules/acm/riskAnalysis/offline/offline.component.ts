...
export class OfflineComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Offline Analysis Profiles"
    ...
    mainCols = [
        ...
        { field: 'rule', type: 'text', header: 'Modified On' },
        { field: 'rule', type: 'text', header: 'Analysis Type' },
        { field: 'rule', type: 'text', header: 'Target Type' },
        { field: 'rule', type: 'text', header: 'Mitigations' },
