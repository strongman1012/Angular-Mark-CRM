...
export class TasksComponent implements AfterViewInit, OnInit {
    ...
    mainCols = [
        { field: 'rule', type: 'text', header: 'Task ID' },
        { field: 'rule', type: 'text', header: 'Requester' },
        { field: 'rule', type: 'text', header: 'Submitted Date' },
        { field: 'rule', type: 'text', header: 'Result' },
        { field: 'rule', type: 'text', header: 'Progress' },
        { field: 'rule', type: 'text', header: 'View Detail' },
    ];
