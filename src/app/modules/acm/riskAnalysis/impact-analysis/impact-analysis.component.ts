...
export class ImpactAnalysisComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Impact Analysis Profile"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Profile' },
        { field: 'rule', type: 'text', header: 'Description' },
        { field: 'rule', type: 'text', header: 'Roles Source' },
        { field: 'rule', type: 'text', header: 'Users Source' },
        { field: 'rule', type: 'text', header: 'Analysis Type' },
        { field: 'rule', type: 'text', header: 'Mitigations Included' },
        { field: 'rule', type: 'text', header: 'Created On' },
        { field: 'rule', type: 'text', header: 'Created By' },
    ];
