...
export class RiskTypeComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Risk Types"
    tableTwoTitle = "Rules"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Risk Type' },
        { field: 'rule', type: 'text', header: 'Color' },
    ];
