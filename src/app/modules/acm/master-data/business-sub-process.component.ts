...
export class BusinessSubProcessComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Business Sub Processes"
    tableTwoTitle = "Rules"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Business Sub Process' },
        { field: 'rule', type: 'text', header: 'Business Process' },
    ];
