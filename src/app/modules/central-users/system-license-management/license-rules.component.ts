...
export class LicenseRulesComponent implements AfterViewInit, OnInit {
    products2 = []
    tableOneTitle = "License Management Rules"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Select Rule' },
        { field: 'rule', type: 'text', header: 'Value' },
    ];
