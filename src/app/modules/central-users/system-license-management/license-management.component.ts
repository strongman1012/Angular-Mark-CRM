...
export class LicenseManagementComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Systems License Management"
    tableTwoTitle = "Results"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'business-process', type: 'text', header: 'System' },
        { field: 'rule', type: 'text', header: 'Type' },
        { field: 'description', type: 'text', header: 'Description' },
        { field: 'sub-process', type: 'text', header: 'As Per SAP' },
        { field: 'sub-process', type: 'text', header: 'Purchased' },
        { field: 'sub-process', type: 'text', header: 'Cost' },
        { field: 'sub-process', type: 'text', header: 'As Per MARC' },
        { field: 'sub-process', type: 'text', header: 'Cost' },
    ];
    subCols = [
    ];
