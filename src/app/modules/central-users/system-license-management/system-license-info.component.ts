...
export class SystemLicenseInfoComponent implements AfterViewInit, OnInit {
    products2 = []
    tableOneTitle = "Systems License Information"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'License Type' },
        { field: 'rule', type: 'text', header: 'Description' },
        { field: 'rule', type: 'text', header: 'Purchased' },
        { field: 'rule', type: 'text', header: 'Cost Per Unit' },
        { field: 'rule', type: 'text', header: 'Total Value' },
    ];
