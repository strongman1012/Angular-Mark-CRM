...
export class LicenseIndirectUsageComponent implements AfterViewInit, OnInit {
    tableOneTitle = "License Indirect Usage Info"
    tableTwoTitle = "Indirect Usage Users"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Application' },
        { field: 'description', type: 'text', header: 'App User ID' },
        { field: 'business-process', type: 'text', header: 'System' },
        { field: 'sub-process', type: 'text', header: 'No of Users' },
        { field: 'sub-process', type: 'text', header: 'License Type' },
        { field: 'sub-process', type: 'text', header: 'Run By' },
    ];
    subCols = [
        { field: 'rule', type: 'text', header: 'Application ID' },
        { field: 'description', type: 'text', header: 'SAP ID' },
        { field: 'business-process', type: 'text', header: 'Name' },
