...
export class ScheduledTaskComponent implements AfterViewInit, OnInit {
    products2 = []
    tableOneTitle = "Central User Scheduled Task"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Task' },
        { field: 'rule', type: 'text', header: 'Report' },
        { field: 'rule', type: 'text', header: 'Started Date' },
        { field: 'rule', type: 'text', header: 'End Date' },
        { field: 'rule', type: 'text', header: 'Repeat After' },
        { field: 'rule', type: 'text', header: 'Last Executed On' },
        { field: 'rule', type: 'text', header: 'Next Execution' },
