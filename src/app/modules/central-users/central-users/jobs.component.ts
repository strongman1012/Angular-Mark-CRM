...
export class JobsComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Central User Report Jobs"
    tableTwoTitle = "Job Logs"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Profile' },
        { field: 'description', type: 'text', header: 'Status' },
        { field: 'business-process', type: 'text', header: 'Started On' },
        { field: 'sub-process', type: 'text', header: 'Completed On' },
