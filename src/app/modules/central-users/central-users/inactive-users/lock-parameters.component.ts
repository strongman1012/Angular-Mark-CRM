...
export class LockParametersComponent implements AfterViewInit, OnInit {
    ...
    tableOneTitle = "Lock Parameters"
    tableTwoTitle = "Users"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'description', type: 'text', header: 'Select Parameter' },
        { field: 'business-process', type: 'text', header: 'Value' },
