...
export class AuditLogsComponent implements AfterViewInit, OnInit {
    tableOneTitle = "Privelege Audit Log"
    tableTwoTitle = "Change Details"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'rule', type: 'text', header: 'Privelege' },
        { field: 'description', type: 'text', header: 'Action' },
        { field: 'business-process', type: 'text', header: 'Time' },
        { field: 'sub-process', type: 'text', header: 'Updated by' },
    ];
    subCols = [
        { field: 'auth-object', type: 'text', header: 'Property' },
        { field: 'auth-field', type: 'text', header: 'Before' },
        { field: 'value', type: 'text', header: 'After' },
    ];
