...
export class ReasonComponent implements AfterViewInit, OnInit {
    ...
    tableOneTitle = "Pam Reason"
    tableTwoTitle = "Users"
    rowsPerPageOptions = [3, 4, 5]
    startingDisplayAmout = 3;
    mainCols = [
        { field: 'description', type: 'text', header: 'ID' },
        { field: 'business-process', type: 'text', header: 'User Code' },
        { field: 'sub-process', type: 'text', header: 'Descritpion' },
    ];
    subCols = [
