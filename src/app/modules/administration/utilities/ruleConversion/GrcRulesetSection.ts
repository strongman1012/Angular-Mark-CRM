    ...
    <section class="mt-10 mx-10">
        <p-card class="w-full justify-center" p-card-header="title">
            ...
            <div *ngFor="let field of fields" class="flex mt-5 px-5">
                <p class="w-72 my-auto">{{field.title}}:</p>
...
export class GrcRulesetSection implements OnInit, OnDestroy {
    loading: boolean;
    fields = [
        {
            title: 'Function Permission File'
        },
        {
            title: 'Function File'
        },
        {
            title: 'Function Business Process File'
        },
        {
            title: 'Risks File'
        },
        {
            title: 'Risk Description File'
        }
