...
import {PrimeNGThemeService} from '../theme.service';
...
export class LayoutComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    // Set the app version
    this._renderer2.setAttribute(this._document.querySelector('[ng-version]'),
        'fuse-version', FUSE_VERSION);

    // Set the OS name
    this._renderer2.addClass(this._document.body,
  ...
  private _updateScheme(): void {
    ...
    this._primengThemeService.switchTheme(this.scheme);
  }
